...
<dialog id="earnings_team_member_dialog"
        ...
        data-dialog-close-tts="<?php echo htmlspecialchars(earnings_i18n('EARNINGS_MEMBER_EARNINGS', 'Member Earnings'), ENT_QUOTES, 'UTF-8'); ?>"
  ...
  <section class="modal_header">
    <button type="button" class="btn btn_close" data-dialog-close="earnings_team_member_dialog" commandfor="earnings_team_member_dialog" command="close" aria-label="<?php echo htmlspecialchars($i18n['CLOSE'], ENT_QUOTES, 'UTF-8'); ?>">&times;</button>
  ...
  <section class="modal_footer">
    <button type="button" class="btn btn_secondary" data-dialog-close="earnings_team_member_dialog" commandfor="earnings_team_member_dialog" command="close"><?php echo htmlspecialchars($i18n['CLOSE'], ENT_QUOTES, 'UTF-8'); ?></button>
  </section>
</dialog>

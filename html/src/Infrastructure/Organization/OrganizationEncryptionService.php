...
namespace PayCal\Infrastructure\Organization;
...
/**
 * OrganizationEncryptionService.php
 *
 * Purpose: Coordinate organization-scoped DEK wrap storage and retrieval under
 ...
 *
 * Architectural role:
 * - Reusable domain service for organization-scoped encryption-wrap storage,
 *   lookup, and consent-bound resolution.
 * - Encapsulates organization encryption policy outside the HTTP layer.
 *
 * @category   Infrastructure
 * @package    PayCal\Infrastructure\Organization
 * @subpackage Core

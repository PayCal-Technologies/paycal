...
namespace PayCal\Infrastructure\Content;
 ...
 * BlogRepository.php
 *
 * Purpose: Markdown-backed content repository for blog post discovery,
 * frontmatter parsing, filtering, pagination, and render-safe transformation.
 *
 * Developer notes:
 * - Keep filesystem parsing behavior stable because blog metadata drives page
 *   listings, tag views, and published ordering.
 * - Rendering helpers should remain content-focused rather than absorbing page
 *   controller concerns.
 *
 * Architectural role:
 * - Reusable domain repository for content lookup and transformation from the
 *   filesystem-backed blog source of truth.
 * - Encapsulates blog-content parsing outside the HTTP layer.
 *
 * @category   Infrastructure
 * @package    PayCal\Infrastructure\Content
 * @subpackage Core

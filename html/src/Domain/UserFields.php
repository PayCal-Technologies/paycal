...
enum UserFields: string
{
  ...
  case TOAST_WIDTH_PRESET = 'toast_width_preset';
  case TOAST_FONT_SIZE = 'toast_font_size';
  ...
  case CALENDAR_DAY_NAME_POSITION = 'calendar_day_name_position';
  ...
  case CALENDAR_WORK_ENTRY_FIELDS_REGULAR = 'calendar_work_entry_fields_regular';
  ...
  case CALENDAR_WEEK_START = 'calendar_week_start';
  case CALENDAR_DEFAULT_VIEW = 'calendar_default_view';
  case CALENDAR_SHOW_GROSS_BADGE = 'calendar_show_gross_badge';
  case CALENDAR_SHOW_NET_BADGE = 'calendar_show_net_badge';
  case CALENDAR_SHOW_DEDUCTIONS_BADGE = 'calendar_show_deductions_badge';
  case CALENDAR_HIGHLIGHT_PAY_PERIOD = 'calendar_highlight_pay_period';
  case ACCENT_PRESET = 'accent_preset';
  case HIGH_CONTRAST_ENABLED = 'high_contrast_enabled';
  case REDUCED_MOTION_ENABLED = 'reduced_motion_enabled';
  case SR_VERBOSITY = 'sr_verbosity';
  case KEYBOARD_SHORTCUTS_HINT = 'keyboard_shortcuts_hint';
  case REQUIRE_REAUTH_EXPORT = 'require_reauth_export';
  case REQUIRE_REAUTH_IMPORT = 'require_reauth_import';
  case EXPORT_ENCRYPT_PREFERENCE = 'export_encrypt_preference';
  case DEBUG_TTL_MINUTES = 'debug_ttl_minutes';
  case DEBUG_ENABLED_UNTIL = 'debug_enabled_until';
  case EDITING_GRACE_DAYS = 'editing_grace_days';
  case VOICE = 'voice';
  case VOICE_VOLUME = 'voice_volume';

...
final class SystemConfig
{
  ...
  public const ENCRYPTION_TELEMETRY_SCHEMA = 'v1';
    ...
    private const SCHEMA = [
      ...
      'early_access.page_enabled' => [
        'type' => 'bool',
        'category' => 'features',
        'default' => false,
        'label' => 'Enable Early Access Page',
        'help' => 'Show the authenticated Early Access settings page when eligible features are available',
      ],
      'auth.immediate_ui.enrollment_enabled' => [
        'type' => 'bool',
        'category' => 'features',
        'default' => false,
        'label' => 'Enable Immediate UI Enrollment',
        'help' => 'Allow eligible users to activate faster passkey sign-in for this browser',
      ],
      'auth.immediate_ui.runtime_enabled' => [
        'type' => 'bool',
        'category' => 'features',
        'default' => false,
        'label' => 'Enable Immediate UI Runtime',
        'help' => 'Allow signed-out pages to attempt Chrome Immediate UI when a browser activation token is valid',
      ],
      'auth.immediate_ui.rollout_mode' => [
        'type' => 'string',
        'category' => 'features',
        'default' => 'staff',
        'label' => 'Immediate UI Rollout Mode',
        'help' => 'Controls account eligibility for faster passkey sign-in',
        'options' => ['staff', 'allowlist', 'percentage', 'all'],
      ],
      'auth.immediate_ui.rollout_percent' => [
        'type' => 'int',
        'category' => 'features',
        'default' => 0,
        'min' => 0,
        'max' => 100,
        'label' => 'Immediate UI Rollout Percent',
        'help' => 'Deterministic percentage of eligible accounts included when rollout mode is percentage',
      ],
      'auth.immediate_ui.activation_version' => [
        'type' => 'int',
        'category' => 'features',
        'default' => 1,
        'min' => 1,
        'max' => 1000000,
        'label' => 'Immediate UI Activation Version',
        'help' => 'Increment to invalidate existing browser activation cookies',
      ],
      'auth.immediate_ui.activation_ttl_days' => [
        'type' => 'int',
        'category' => 'features',
        'default' => 30,
        'min' => 1,
        'max' => 365,
        'label' => 'Immediate UI Activation TTL Days',
        'help' => 'Lifetime of the browser activation cookie',
      ],
      'auth.immediate_ui.passkeys_only' => [
        'type' => 'bool',
        'category' => 'features',
        'default' => true,
      ...
      'font_family_sans' => [
        'type' => 'string',
        'category' => 'ui',
        'default' => 'system-ui, -apple-system, BlinkMacSystemFont, "Segoe UI", Arial, sans-serif',
      ...
      'font_family_monospace' => [
        'type' => 'string',
        'category' => 'ui',
        'default' => 'ui-monospace, SFMono-Regular, Menlo, Monaco, Consolas, "Liberation Mono", monospace',

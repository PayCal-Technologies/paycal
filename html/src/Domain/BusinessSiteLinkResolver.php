...
/**
 * BusinessSiteLinkResolver
 *
 * Normalizes and resolves whether a work entry belongs to an business's
 * linked site set using deterministic matching tiers.
 */
final class BusinessSiteLinkResolver
{
  /**
   * Build business site link context used for work-entry matching.
   *
   * @return array{
  ...
  {
    $orgSiteRefs = Database::smembers(Keys::BUSINESS_SITE . ':' . $orgId);

...
<p><?php echo htmlspecialchars($i18n['LAST_UPDATED'], ENT_QUOTES, 'UTF-8'); ?> <?php echo htmlspecialchars($i18n['FAQ_LAST_UPDATED_DATE'], ENT_QUOTES, 'UTF-8'); ?>.</p>

...
<div id="business-workspace" class="business_workspace business_audit" data-business-subpage="audit"<?php echo $workspaceBusinessIdAttr; ?>>
  ...
  <section class="panel business_audit_summary" aria-labelledby="business_audit_summary_heading">
    <div class="businesses_section_header">
      <h2 id="business_audit_summary_heading"><?php echo businesses_index_i18n('BUSINESS_GOVERNANCE_SUMMARY_TITLE'); ?></h2>
      <a class="btn btn_secondary" href="/business/members/"><?php echo businesses_index_i18n('BUSINESS_DASHBOARD_MANAGE_MEMBERS'); ?></a>
    </div>
    <p class="help_text"><?php echo businesses_index_i18n('BUSINESS_GOVERNANCE_SUMMARY_HELP'); ?></p>
<?php if ($auditSummaryAvailable) { ?>
    <dl class="businesses_exec_summary_metrics business_audit_metrics">
      ...
      <div class="businesses_exec_metric">
        <dt><?php echo businesses_index_i18n('BUSINESS_GOVERNANCE_REVOKED_CONNECTIONS'); ?></dt>
        <dd id="business_audit_revoked"><?php echo htmlspecialchars($auditMetricValue($auditRevokedRelationships), ENT_QUOTES, 'UTF-8'); ?></dd>
      </div>
    </dl>
<?php } else { ?>
    <p class="help_text business_audit_summary_empty"><?php echo businesses_index_i18n('BUSINESSES_SELECT_FIRST'); ?></p>
<?php } ?>
  </section>

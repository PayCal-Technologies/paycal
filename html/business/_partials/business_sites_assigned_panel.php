...
?>
  <section class="panel businesses_sites_assigned_panel">
    <div class="business_status_legend_row">
      <div class="business_status_action_group" role="group" aria-label="<?php echo businesses_index_i18n_html('BUSINESS_SITES_STATUS_TABS_ARIA'); ?>">
        <ul class="tabs business_sites_status_tabs">
          <li>
            <button type="button" class="tab active" data-business-sites-status="active" aria-pressed="true">
              <?php echo businesses_index_i18n_html('BUSINESS_SITES_TAB_ACTIVE'); ?>
            </button>
          </li>
          <li>
            <button type="button" class="tab" data-business-sites-status="archived" aria-pressed="false">
              <?php echo businesses_index_i18n_html('BUSINESS_SITES_TAB_ARCHIVED'); ?>
            </button>
          </li>
        </ul>
        ...
        <button
          ...
          aria-label="<?php echo businesses_index_i18n_html('BUSINESS_SITES_ADD_ARIA'); ?>"
        ><?php echo businesses_index_i18n_html('BUSINESS_STATUS_ADD_SHORT'); ?></button>
        <?php } ?>
      </div>

      <div class="business_sites_ownership_legend" aria-label="<?php echo businesses_index_i18n_html('BUSINESS_SITES_OWNERSHIP_LEGEND_ARIA'); ?>">
        <span class="business_sites_ownership_legend_item">
          ...
          <span><?php echo businesses_index_i18n_html('BUSINESS_SITES_STATUS_TAG_BUSINESS'); ?></span>
        </span>
        <span class="business_sites_ownership_legend_item">
          <span class="business_sites_ownership_symbol business_sites_ownership_symbol--personal" aria-hidden="true"></span>
          <span><?php echo businesses_index_i18n_html('BUSINESS_SITES_STATUS_TAG_PERSONAL'); ?></span>
        </span>
        <span class="business_sites_ownership_legend_item">
          <span class="business_sites_ownership_symbol business_sites_ownership_symbol--shared" aria-hidden="true"></span>
          <span><?php echo businesses_index_i18n_html('BUSINESS_SITES_STATUS_TAG_SHARED'); ?></span>
        </span>
      </div>
    ...
    <div id="businesses_sites_active_panel">
      <div class="visually_hidden">
        <p id="businesses_sites_sr_instructions"><?php echo businesses_index_i18n_html('BUSINESS_SITES_ASSIGNED_SR'); ?></p>
        <p id="businesses_sites_grid_sr_context"><?php echo businesses_index_i18n_html('BUSINESS_SITES_GRID_SR_CONTEXT'); ?></p>
      ...
      <div
        ...
        role="region"
        aria-label="<?php echo businesses_index_i18n_html('BUSINESS_SITES_GRID_ARIA'); ?>"

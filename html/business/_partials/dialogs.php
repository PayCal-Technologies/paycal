      ...
      <section class="modal_content f_column businesses_definitions_dialog_content">
        ...
        <div class="businesses_definitions_grid">
          <article class="businesses_definition_card" aria-labelledby="businesses_definition_type_title">
            <h3 id="businesses_definition_type_title"><?php echo businesses_index_i18n_html('BUSINESSES_DEFINITION_TYPE'); ?></h3>
            <dl class="businesses_definition_list">
              <dt><?php echo businesses_index_i18n_html('BUSINESSES_TYPE_PERSONAL'); ?></dt>
              <dd><?php echo businesses_index_i18n_html('BUSINESSES_DEF_TYPE_PERSONAL_DD'); ?></dd>
              <dt><?php echo businesses_index_i18n_html('BUSINESSES_TYPE_SHARED'); ?></dt>
              <dd><?php echo businesses_index_i18n_html('BUSINESSES_DEF_TYPE_SHARED_DD'); ?></dd>
            </dl>
          </article>

          <article class="businesses_definition_card" aria-labelledby="businesses_definition_role_title">
            <h3 id="businesses_definition_role_title"><?php echo businesses_index_i18n_html('BUSINESSES_ROLE'); ?></h3>
            <dl class="businesses_definition_list">
              <dt><?php echo businesses_index_i18n_html('BUSINESSES_ROLE_OWNER'); ?></dt>
              <dd><?php echo businesses_index_i18n_html('BUSINESSES_DEF_ROLE_OWNER_DD'); ?></dd>
              <dt><?php echo businesses_index_i18n_html('BUSINESSES_ROLE_COORDINATOR'); ?></dt>
              <dd><?php echo businesses_index_i18n_html('BUSINESSES_DEF_ROLE_COORDINATOR_DD'); ?></dd>
              <dt><?php echo businesses_index_i18n_html('BUSINESSES_ROLE_CONTRIBUTOR'); ?></dt>
              <dd><?php echo businesses_index_i18n_html('BUSINESSES_DEF_ROLE_CONTRIBUTOR_DD'); ?></dd>
              <dt><?php echo businesses_index_i18n_html('BUSINESSES_ROLE_VIEWER'); ?></dt>
              <dd><?php echo businesses_index_i18n_html('BUSINESSES_DEF_ROLE_VIEWER_DD'); ?></dd>
              <dt><?php echo businesses_index_i18n_html('BUSINESSES_ROLE_MEMBER'); ?></dt>
              <dd><?php echo businesses_index_i18n_html('BUSINESSES_DEF_ROLE_MEMBER_DD'); ?></dd>
            </dl>
          </article>

          <article class="businesses_definition_card" aria-labelledby="businesses_definition_status_title">
            <h3 id="businesses_definition_status_title"><?php echo businesses_index_i18n_html('STATUS'); ?></h3>
            <dl class="businesses_definition_list">
              <dt><?php echo businesses_index_i18n_html('BUSINESSES_STATUS_ACTIVE'); ?></dt>
              <dd><?php echo businesses_index_i18n_html('BUSINESSES_DEF_STATUS_ACTIVE_DD'); ?></dd>
              <dt><?php echo businesses_index_i18n_html('BUSINESSES_PENDING'); ?></dt>
              <dd><?php echo businesses_index_i18n_html('BUSINESSES_DEF_STATUS_PENDING_DD'); ?></dd>
            </dl>
          </article>
        </div>
      </section>
    ...
    <form id="businesses_membership_consent_form" method="dialog">
      ...
      <section class="modal_content f_column businesses_membership_consent_content">
        ...
        <section class="businesses_membership_consent_matrix" aria-labelledby="businesses_membership_consent_matrix_title">
          <h3 id="businesses_membership_consent_matrix_title" class="section_title_sm"><?php echo businesses_index_i18n_html('BUSINESSES_HIERARCHY_PERMISSIONS_TITLE'); ?></h3>
        ...
        <label for="businesses_membership_consent_disclaimer" class="form_label"><?php echo businesses_index_i18n_html('BUSINESSES_MEMBERSHIP_CONSENT_DISCLAIMER_LABEL'); ?></label>
        <textarea id="businesses_membership_consent_disclaimer" rows="3" maxlength="600" placeholder="<?php echo businesses_index_i18n_html('BUSINESSES_MEMBERSHIP_CONSENT_DISCLAIMER_PLACEHOLDER'); ?>"></textarea>
        <label for="businesses_membership_consent_ack" class="businesses_membership_consent_ack_label">
          ...
          <span><?php echo businesses_index_i18n_html('BUSINESSES_MEMBERSHIP_CONSENT_ACK_TEXT'); ?></span>
        </label>

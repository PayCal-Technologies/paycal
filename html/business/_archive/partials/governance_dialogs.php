  ...
  <dialog id="businesses_browser_profile_dialog" class="dialog businesses_browser_profile_dialog" aria-modal="true" aria-labelledby="businesses_browser_profile_title" aria-describedby="businesses_browser_profile_desc">
    <form method="dialog">
      <section class="modal_header">
        <h2 id="businesses_browser_profile_title" class="modal_title"><?php echo businesses_index_i18n_html('BUSINESSES_BROWSER_PROFILE_TITLE'); ?></h2>
        <button type="button" class="btn_close" data-dialog-close="businesses_browser_profile_dialog" aria-label="<?php echo businesses_index_i18n_html('CLOSE'); ?>">&times;</button>
      </section>
      <section class="modal_content f_column businesses_browser_profile_content">
        <p id="businesses_browser_profile_desc" class="help_text"><?php echo businesses_index_i18n_html('BUSINESSES_BROWSER_PROFILE_DESC'); ?></p>
      ...
      <section class="modal_footer">
        <button type="button" id="businesses_browser_profile_connect" class="btn btn_primary"><?php echo businesses_index_i18n_html('BUSINESSES_BROWSER_REQUEST_ACCESS'); ?></button>
        <button type="button" class="btn btn_secondary" data-dialog-close="businesses_browser_profile_dialog"><?php echo businesses_index_i18n_html('CLOSE'); ?></button>
      </section>
    </form>
  </dialog>

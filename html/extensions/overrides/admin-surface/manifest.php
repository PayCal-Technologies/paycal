...
return [
  ...
  'capabilities' => [
    ...
    'admin.nav.links' => [
      ...
      ['href' => '/admin/argus/', 'label_key' => 'ARGUS', 'icon' => 'metrics', 'match_prefix' => '/admin/argus'],
      ['href' => '/admin/business-moderation/', 'label_key' => 'BUSINESS_MODERATION', 'icon' => 'admin', 'match_prefix' => '/admin/business-moderation'],

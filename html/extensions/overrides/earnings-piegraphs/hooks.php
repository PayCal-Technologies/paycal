...
final class Hooks
{
  ...
  public static function render(array $context): string
  {
    ...
    $monthLabel = self::esc(self::payloadText($payload, 'month_label', 'Month'));
    $yearAttr = (string) $year;
    $ytdLegendId = 'earnings_piegraphs_ytd_legend_' . $yearAttr;
    $monthLegendId = 'earnings_piegraphs_month_legend_' . $yearAttr;
    ...
    return '<section class="panel w100 earnings_panel earnings_piegraphs_panel" id="earnings_piegraphs_panel_' . $yearAttr . '" data-earnings-piegraphs-year="' . $yearAttr . '">'
      ...
      . '<svg id="earnings_piegraphs_ytd_svg_' . $yearAttr . '" class="earnings_piegraphs_svg" viewBox="0 0 240 240" role="img" aria-label="' . $ytdTitle . ' ' . $yearAttr . '" aria-describedby="' . $ytdLegendId . '" focusable="false"></svg>'
      ...
      . '<select id="earnings_piegraphs_month_select_' . $yearAttr . '" class="earnings_piegraphs_month_select" data-earnings-piegraphs-year="' . $yearAttr . '" aria-label="' . $monthLabel . '"></select>'
      . '</div>'
      . '<svg id="earnings_piegraphs_month_svg_' . $yearAttr . '" class="earnings_piegraphs_svg" viewBox="0 0 240 240" role="img" aria-label="' . $monthlyTitle . ' ' . $yearAttr . '" aria-describedby="' . $monthLegendId . '" focusable="false"></svg>'

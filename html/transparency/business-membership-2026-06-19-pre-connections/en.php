...
<article class="article doc-article">
  ...
  <header class="doc-article-header">
    ...
    <p class="deck">
      This page explains the shift from loosely-coupled group semantics to an explicit
  ...
  <div class="doc-article-body">
    <section class="doc-section highlight">
      ...
      <p>
        The Business <strong>&lt;-&gt;</strong> Member structure gives every actor an explicit
        relationship to a business with policy-aware status, role, and scope behavior.
      </p>
    </section>

    <section class="doc-section">
      <h2>Business <strong>&lt;-&gt;</strong> Member Relationship Changes</h2>
      <ul class="doc-list">
        ...
        <li>Business panels and notifications now reflect relationship transitions and role outcomes more consistently.</li>
        <li>Shared business behavior is governed by membership state before privileged actions are processed.</li>
      </ul>
    </section>
    ...
    <section class="doc-section">
      ...
      <p>
        Business collaboration intersects with encryption and consent controls. Membership and role checks
        gate shared business envelope behavior so sensitive operations remain policy-bound.
      </p>
      <ul class="doc-list">

...
$pageTitle = 'Organisatielidmaatschap en rolfilosofie - [PayCal]';
$pageLabel = 'Organisatielidmaatschap en rolfilosofie';
...
<article class="article doc-article">
  ...
  <header class="doc-article-header">
    <h1>Organisatielidmaatschap en rolfilosofie</h1>
    <p class="deck">

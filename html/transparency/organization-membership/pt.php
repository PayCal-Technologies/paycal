...
$pageTitle = 'Adesao organizacional e filosofia de funcoes - [PayCal]';
$pageLabel = 'Adesao organizacional e filosofia de funcoes';
...
<article class="article doc-article">
  ...
  <header class="doc-article-header">
    <h1>Adesão organizacional e filosofia de funções</h1>
    <p class="deck">

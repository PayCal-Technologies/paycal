...
$pageTitle = 'Membresia organizacional y filosofia de roles - [PayCal]';
$pageLabel = 'Membresia organizacional y filosofia de roles';
...
<article class="article doc-article">
  ...
  <header class="doc-article-header">
    <h1>Membresía organizacional y filosofía de roles</h1>
    <p class="deck">

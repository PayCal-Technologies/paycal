...
$pageTitle = 'Appartenenza organizzativa e filosofia dei ruoli - [PayCal]';
$pageLabel = 'Appartenenza organizzativa e filosofia dei ruoli';
...
<article class="article doc-article">
  ...
  <header class="doc-article-header">
    <h1>Appartenenza organizzativa e filosofia dei ruoli</h1>
    <p class="deck">

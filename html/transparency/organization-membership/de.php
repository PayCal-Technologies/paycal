...
$pageTitle = 'Organisationsmitgliedschaft und Rollenphilosophie - [PayCal]';
$pageLabel = 'Organisationsmitgliedschaft und Rollenphilosophie';
...
<article class="article doc-article">
  ...
  <header class="doc-article-header">
    <h1>Organisationsmitgliedschaft und Rollenphilosophie</h1>
    <p class="deck">
      Diese Seite erklärt den Übergang von locker gekoppelter Team-Semantik zu einem expliziten

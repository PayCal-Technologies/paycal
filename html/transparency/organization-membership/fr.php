...
$pageTitle = 'Adhesion organisationnelle et philosophie des roles - [PayCal]';
$pageLabel = 'Adhesion organisationnelle et philosophie des roles';
...
<article class="article doc-article">
  ...
  <header class="doc-article-header">
    <h1>Adhésion organisationnelle et philosophie des rôles</h1>
    <p class="deck">

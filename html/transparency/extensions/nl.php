...
$pageTitle = 'Extensieparadigma - [PayCal]';
$pageLabel = 'Extensieparadigma';
  ...
  <div class="doc-article-body">
    ...
    <section class="doc-section">
      ...
      <ul class="doc-list">
        ...
        <li><strong>organization-signals:</strong> basisorganisatiesignaal-hooks</li>
      </ul>
    </section>

...
$pageTitle = 'SOC 2 Pagsunod sa PayCal - [PayCal]';
$pageLabel = 'SOC 2 Pagsunod sa PayCal';
...
<article class="article doc-article">
  <nav class="doc-breadcrumb" aria-label="Breadcrumb">
    ...
    <span class="current">SOC 2 Pagsunod sa PayCal</span>
  </nav>

  <header class="doc-article-header">
    <h1>SOC 2 Kahandaan at Modelo ng Seguridad ng PayCal</h1>

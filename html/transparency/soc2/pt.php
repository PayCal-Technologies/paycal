...
$pageTitle = 'Conformidade SOC 2 no PayCal - [PayCal]';
$pageLabel = 'Conformidade SOC 2 no PayCal';
...
<article class="article doc-article">
  <nav class="doc-breadcrumb" aria-label="Navegação estrutural">
    ...
    <span class="current">Conformidade SOC 2 no PayCal</span>
  </nav>

  <header class="doc-article-header">
    <h1>Prontidão SOC 2 e modelo de segurança do PayCal</h1>

...
/* PAYCAL WHITE LIGHT */
:root {
  --foundation-paper-000:                hsl(0 0% 100%);
  --foundation-paper-100:                hsl(0 0% 97%);
  --foundation-paper-200:                hsl(0 0% 93%);
  --foundation-paper-300:                hsl(0 0% 84%);
  --foundation-ink-000:                  hsl(0 0% 8%);
  --foundation-ink-100:                  hsl(0 0% 14%);
  --foundation-ink-200:                  hsl(0 0% 24%);
  --foundation-border-100:               hsl(0 0% 46%);
  --foundation-accent-100:               hsl(0 0% 10%);
  --foundation-accent-200:               hsl(0 0% 0%);

  --color-bg:                            var(--foundation-paper-000);
  --color-bg-soft:                       hsl(0 0% 98%);
  --color-bg-elevated:                   var(--foundation-paper-200);
  --color-bg-overlay:                    hsl(0 0% 4% / 0.22);
  --color-surface:                       var(--foundation-paper-100);
  --color-surface-muted:                 hsl(0 0% 95%);
  --color-surface-strong:                var(--foundation-paper-200);
  --input-bg:                            hsl(0 0% 100%);

  --color-border:                        hsl(0 0% 42%);
  --color-border-soft:                   hsl(0 0% 70%);
  ...
  --color-primary-soft:                  hsl(0 0% 0% / 0.10);
  --color-on-primary:                    hsl(0 0% 98%);
  ...
  --color-hover:                         hsl(0 0% 0% / 0.06);
  --color-active:                        hsl(0 0% 0% / 0.12);
  --color-focus-ring:                    hsl(0 0% 4%);
  --color-selection:                     hsl(0 0% 0% / 0.16);
  --color-highlight:                     hsl(48 90% 62% / 0.28);

  --elevation-1-bg:                      hsl(0 0% 97%);
  --elevation-2-bg:                      var(--foundation-paper-100);
  --elevation-3-bg:                      var(--foundation-paper-200);
  --overlay-backdrop:                    hsl(0 0% 0% / 0.20);
  --shadow-md:                           0 8px 18px hsl(0 0% 0% / 0.13);

  --button-bg:                           var(--foundation-paper-200);
  --button-bg-hover:                     hsl(0 0% 88%);
  --button-bg-active:                    hsl(0 0% 82%);
  --button-text:                         var(--color-text);
  --button-border:                       var(--color-border);
  --button-border-active:                var(--color-primary-hover);
  --button-primary-bg:                   var(--color-primary);
  --button-primary-text:                 #ffffff;
  --button-secondary-bg:                 hsl(0 0% 92%);
  ...
  --calendar-day-bg:                     hsl(0 0% 100%);
  --calendar-day-hover:                  hsl(0 0% 88%);
  ...
  --btn-back-linear-gradient:            linear-gradient(135deg, hsl(0 0% 100%) 0%, hsl(0 0% 94%) 100%);
  --btn-back-hover-linear-gradient:      linear-gradient(0deg, hsl(0 0% 97%) 0%, hsl(0 0% 86%) 100%);
  ...
  --work-back:                           linear-gradient(135deg, hsl(0 0% 92%) 0%, hsl(0 0% 90%) 100%);
  --work-entry-back:                     hsl(0 0% 100%);

...
final class SettingsBacklogPartialContractTest extends TestCase
{
  ...
  public function backlogPartialsExposeExpectedControlIds(): void
  {
    $files = [
      ...
      'panel_appearance_theme.php' => ['id="density_preset_', 'id="depth_preset_', 'accent_preset'],
      ...
      'panel_data.php' => ['panel-data-consent', 'settings_data_consent_status', 'settings_data_consent_counts', 'data-business-consent-action', 'panel-data-export-reality', 'settings_export_history_list'],
      'panel_security_passkeys.php' => ['settings_recovery_key_badge', 'create_recovery_key_btn', 'settings_recovery_key_status_value'],

...
final class WorkEntryBusinessEnvelopeValidationTest extends TestCase
{
  ...
  {
    parent::setUp();
    $this->originalStrictEnvelope = (bool) SystemConfig::get('business_shared_encryption_enforce_strict_envelope');
  }

  protected function tearDown(): void
  {
    SystemConfig::set('business_shared_encryption_enforce_strict_envelope', $this->originalStrictEnvelope);
    parent::tearDown();
  }
  ...
  {
    SystemConfig::set('business_shared_encryption_enforce_strict_envelope', true);
  ...
  #[Test]
  public function businessEnvelopeRequiresMetadataFieldsInStrictMode(): void
  {
    SystemConfig::set('business_shared_encryption_enforce_strict_envelope', true);
    ...
    $this->assertStringStartsWith('missing_business_meta_', $result['error']);
  }

  #[Test]
  public function businessEnvelopeWithRequiredMetadataPassesInStrictMode(): void
  {
    SystemConfig::set('business_shared_encryption_enforce_strict_envelope', true);

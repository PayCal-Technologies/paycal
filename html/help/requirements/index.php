...
/**
 * Help: Browser & Device Requirements — language router
 *
 * PURPOSE: Resolve the visitor's language and forward to the correct locale
 *          template for the Requirements help article. Covers WebAuthn, passkeys,
 *          supported browsers, and HTTPS requirements.
 * LOCATION: html/help/requirements/index.php
 */

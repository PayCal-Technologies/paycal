...
$langFiles = ['en.txt', 'fr.txt', 'de.txt', 'es.txt', 'it.txt', 'nl.txt', 'pt.txt', 'hi.txt', 'tl.txt', 'tr.txt'];

foreach ($langFiles as $file) {
    $filePath = __DIR__ . '/../strings/' . $file;
    ...
    echo "Updated: $file with " . count($newStrings) . " strings\n";
}

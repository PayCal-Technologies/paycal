      ...
      <table width="620" cellpadding="0" cellspacing="0" role="presentation" style="max-width:620px; background:#ffffff; border:1px solid #d8dee4; border-radius:8px; overflow:hidden;">
        <tr>
          <td style="background:#1f2a37; color:#ffffff; padding:16px 20px;">
            <h1 style="margin:0; font-size:20px;"><?php echo Strings::i18n('EMAIL_BUSINESS_ACCESS_REQUEST_TITLE'); ?></h1>
          </td>
        </tr>
        <tr>
          <td style="padding:20px; color:#1f2a37; font-size:15px; line-height:1.55;">
            <p style="margin:0 0 12px 0;"><?php echo Strings::i18n('EMAIL_BUSINESS_ACCESS_REQUESTED_TO'); ?> <strong>__BUSINESS_NAME__</strong>.</p>
            ...
            <p style="margin:0; color:#52606d; font-size:13px;"><?php echo Strings::i18n('EMAIL_BUSINESS_ACCESS_UNKNOWN_NOTICE'); ?></p>
          </td>
        </tr>
      </table>
    </td>

    ...
    <table role="presentation" width="100%" cellspacing="0" cellpadding="0" style="max-width:640px; margin:0 auto; background:#ffffff; border:1px solid #d9e2ec; border-radius:12px;">
      <tr>
        <td style="padding:24px; border-bottom:1px solid #d9e2ec;">
          <h1 style="margin:0; font-size:20px;"><?php echo Strings::i18n('EMAIL_ACCOUNT_RECOVERY_CODE_TITLE'); ?></h1>
          <p style="margin:8px 0 0 0; color:#52606d;"><?php echo Strings::i18n('EMAIL_ACCOUNT_RECOVERY_CODE_SUBTITLE'); ?></p>
        </td>
      </tr>
      <tr>
        <td style="padding:24px;">
          ...
          <p style="margin:0; color:#52606d;"><?php echo Strings::i18n('EMAIL_ACCOUNT_RECOVERY_IGNORE_NOTICE'); ?></p>
        </td>
      </tr>
    </table>
  </body>

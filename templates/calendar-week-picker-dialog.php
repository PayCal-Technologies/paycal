  <dialog id="modal_cal_week_picker" data-dialog-invoker-bridge data-dialog-close-tts="__MODAL_TITLE__" data-dialog-close-on-backdrop="true" aria-modal="true" aria-labelledby="cal_week_picker_title" aria-describedby="cal_week_picker_aria cal_week_picker_meta">
    ...
    <section class="modal_header">
      <button type="button" class="btn btn_close" data-dialog-close="modal_cal_week_picker" commandfor="modal_cal_week_picker" command="close" aria-label="__CLOSE__">&times;</button>
    ...
    <section class="modal_footer">
      <div class="date_picker_actions" role="group" aria-label="__DATE_PICKER_ACTIONS_ARIA__">
        ...
        <button class="btn btn_cancel" type="button" data-dialog-close="modal_cal_week_picker" commandfor="modal_cal_week_picker" command="close">__CLOSE__</button>
      </div>
    </section>
  </dialog>
